...
##系统白噪声和系统输入m序列
系统白噪声和系统输入m序列如图[1](figure/系统噪声及m序列.png)所示。

![1](figure/系统噪声及m序列.png)
...
递推最小二乘的仿真结果如图[2](figure/fig2.png)和图[3](figure/fig3.png)所示。
![2](figure/fig2.png)
![3](figure/fig3.png)
...
\end{matrix}$$
增广最小二乘的仿真结果如图[4](figure/fig4.png)和图[5](figure/fig5.png)所示。
![4](figure/fig4.png)
![5](figure/fig5.png)
